            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-18 py-3">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="p-2.5 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-xl text-white shadow-lg shadow-emerald-500/20 ring-1 ring-white/10">
                            {/* Using Dashboard Logo but maybe generic sports logo would be better, sticking to consistent logo */}
                            {ICONS.DASHBOARD_LOGO}
                        </div>
                        <div>
                            <h1 className="text-xl font-bold text-white tracking-tight leading-none">Player Portal</h1>
                            <div className="flex items-center gap-2 mt-1">
                                <span className="w-1.5 h-1.5 rounded-full bg-blue-500 animate-pulse"></span>
                                <p className="text-[10px] font-bold text-emerald-200/80 uppercase tracking-widest">Athlete Dashboard</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="flex items-center gap-4 pl-6 border-l border-slate-700/50 h-10">
                            <div className="text-right hidden sm:block">
                                ...
                                <p className="text-xs text-slate-500 font-medium">Athlete</p>
                            </div>
                            <div className="relative group cursor-pointer">
                                ...
                                <div className="absolute bottom-0 right-0 w-3 h-3 bg-blue-500 border-2 border-slate-900 rounded-full"></div>
                            </div>
                        </div>
