...
export default function GradientHero({ onSwitchToLogin, onSwitchToRegister }) {
  return (
    <div id="home" className="bg-background relative w-full overflow-hidden">
      {/* Background gradient */}
      ...
      <div className="relative z-10 container mx-auto px-4 py-24 sm:px-6 lg:px-8 lg:py-32">
        <div className="mx-auto max-w-5xl">
          ...
          >
            <div className="border-border bg-background/80 inline-flex items-center rounded-full border px-3 py-1 text-sm backdrop-blur-sm">
              ...
              <span className="text-muted-foreground">
                Advanced sports management platform for teams & tournaments
              </span>
          ...
          >
            Complete sports management solution for teams, players, coaches, and tournaments.
            Track performance, schedule matches, manage statistics, and dominate the field with powerful analytics.
          </motion.p>
