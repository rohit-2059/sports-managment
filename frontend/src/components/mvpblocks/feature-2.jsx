...
const features = [
  {
    ...
    content:
      "Build and organize your sports teams with player profiles, roles, and statistics tracking.",
  ...
  },
  {
    ...
    content:
      "Organize games, practices, and tournaments with our intelligent scheduling system and calendar.",
  ...
  },
  {
    ...
    content:
      "Monitor player statistics, team analytics, and performance metrics with advanced reporting tools.",
  ...
  },
  {
    ...
    content:
      "Create and manage tournaments with brackets, scoring systems, and live match updates.",
    icon: <Code className="text-primary h-6 w-6" />,
    image:
        ...
        <div className="relative mx-auto mb-12 max-w-2xl sm:text-center">
          <div className="relative z-10">
            ...
            <p className="font-geist text-foreground/60 mt-3">
              SportsPro helps you manage teams, schedule matches, track performance,
              and run tournaments all in one place.
            </p>
          </div>
          <div
